...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>F =  K . ( |Q1| . |Q2| ) / <strong>D</strong>²</h2>
			<form method="GET" action="ForcEletrog5.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="F"  required="required"> =
				<input type="number" name="valor2" placeholder="K"  required="required"> . ( |  
				<input type="number" name="valor3" placeholder="Q1"  required="required">| ) . ( |
				<input type="number" name="valor4" placeholder="Q2"  required="required">| ) / D² </b></h3>
