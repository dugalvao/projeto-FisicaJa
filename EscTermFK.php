...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "F - 32 / 9 = $valor1 -273 / 5";?></h3><br/>
			<?php $util1 = $valor1 - 273 ;?>
			<h3><?php echo "F - 32 / 9 = $util1 / 5";?></h3><br/>
			<?php $util2 = $util1 / 5 ;?>
			<h3><?php echo "F - 32 / 9 = $util2";?></h3><br/>
			<h3><?php echo "F - 32 = 9 . $util2";?></h3><br/>
			<?php $util3 = $util2 * 9 ;?>
			<h3><?php echo "F - 32 = $util3";?></h3><br/>
			<h3><?php echo "F = 32 + $util3";?></h3><br/>
			<?php $util4 = $util3 + 32 ;?>
			<h3><?php echo "F = $util4 ºF";?></h3><br/>
