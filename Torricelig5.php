...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			...
			<h3><?php echo "$util1 = $util2 + ( 2 . ( $util3 - ( $valor3 . So )))";?></h3><br/>
			<?php $util4 = $util3 * 2 ;
				  $util5 = $valor3 * 2 ;?>
			<h3><?php echo "$util1 = $util2 + ( $util4 - ( $util5 . So ))";?></h3><br/>
			<h3><?php echo "$util1 - $util2 =  $util4 - ( $util5 . So )";?></h3><br/>
			<?php $util6 = $util1 - $util2 ;?>
			<h3><?php echo "$util6 = $util4 - ( $util5 . So )";?></h3><br/> 
			<h3><?php echo "$util6 + ( $util5 . So ) = $util4 ";?></h3><br/>
			<h3><?php echo " $util5 . So  = $util4 - $util6";?></h3><br/>
			<?php $util7 = $util4 - $util6 ;?>
			<h3><?php echo "$util5 . So  = $util7";?></h3><br/>
			<h3><?php echo "So = $util7 / $util5 ";?></h3><br/>
			<h3><?php echo "So = " . $util7 / $util5 . " m";?></h3><br/>
