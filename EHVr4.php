...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>V = Vo + ( a . <strong>t</strong> )</h2>
			<form method="GET" action="EHVg4.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="V"  required="required"> =
				<input type="number" name="valor2" placeholder="Vo"  required="required"> + (
				<input type="number" name="valor3" placeholder="a"  required="required"> . t )</b></h3>
