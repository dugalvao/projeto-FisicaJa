...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "E = $valor1 . $valor2 / $valor3 ²";?></h3><br/>
			<?php $util1 = $valor1 * $valor2 ;
				  $util2 = $valor3 * $valor3 ;?>
			<h3><?php echo "E = $util1 / $util2";?></h3><br/>
			<?php 
			$resp =  $util1 / $util2;
			$resultForm = number_format($resp, 2,  ',', '');
			?>
			<h3><?php echo "E = $resultForm N/C";?></h3><br/>
		</div>
		<div class="row">
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar10.php",//pagina em php que ira fazer o insert dos dados
