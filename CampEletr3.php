...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<!--<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>E = K .<strong>q</strong> / D²</h2>
			<form method="GET" action="CampEletg3.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="E"  required="required"> =  
				<input type="number" name="valor2" placeholder="K"  required="required"> . q /
				<input type="number" name="valor3" placeholder="D"  required="required">²</b></h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">E = K . <strong> q </strong> / D²</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`CampEletg3.php?valor1=${e}&valor2=${k}&valor3=${d}`);
		}
	</script>
</html>