...
<html lang="pt-br">
    <head>
		<title>Calor Específico - t</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 = $valor2 / $valor3 . ( t - $valor4 )";?></h3><br/>
			<h3><?php echo "$valor1 . $valor3 . ( t - $valor4 ) = $valor2 ";?></h3><br/>
			<?php $util1 = $valor1 * $valor3 ;?>
			<h3><?php echo "$util1 . ( t - $valor4 ) = $valor2 ";?></h3><br/>
			<h3><?php echo "t - $valor4 = $valor2 / $util1";?></h3><br/>
			<?php $util2 = $valor2 / $util1;
			$resultForm1 = number_format($util2, 2,  ',', '');?>
			<h3><?php echo "t - $valor4 = $resultForm1";?></h3><br/>
			<h3><?php echo "t = $resultForm1 + $valor4";?></h3><br/>
			<?php $util3 = $util2 + $valor4;
			$resultForm2 = number_format($util3, 2,  ',', '');?>
			<h3><?php echo "t = $resultForm2 °C";?></h3><br/>
		</div>
		<div class="row">
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar16.php",//pagina em php que ira fazer o insert dos dados
