...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			...
			<h3><?php echo "$valor1 = $valor2 /  m . $util1 ";?></h3><br/>
			<h3><?php echo "$valor1 . ( $util1 . m ) = $valor2 ";?></h3><br/>
			<h3><?php echo "$util1 . m = $valor2 / $valor1";?></h3><br/>
			<?php $util2 = $valor2 / $valor1 ;?>
			<h3><?php echo "$util1 . m = $util2";?></h3><br/>
			<h3><?php echo "m = $util2 / $util1";?></h3><br/>
			<h3><?php echo "m = " . $util2 / $util1 . " g";?></h3><br/>
