...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "$valor1 = K . $valor2 / $valor3 ²";?></h3><br/>
			<?php $util1 = $valor3 * $valor3 ;?>
			<h3><?php echo "$valor1 = K . $valor2 / $util1";?></h3><br/>
			<h3><?php echo "$valor1 . $util1 = K . $valor2";?></h3><br/>
			<?php $util2 = $valor1 * $util1 ;?>
			<h3><?php echo "$util2 = K . $valor2";?></h3><br/>
			<h3><?php echo "$util2 / $valor2 = K ";?></h3><br/>
			<?php $util3 = $util2 / $valor2 ;?>
			<h3><?php echo "K = $util3";?></h3><br/>
