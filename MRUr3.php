...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>S = So + ( <strong>V</strong> . t )</h2>
			<form method="GET" action="MRUg3.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="S"  required="required"> =
				<input type="number" name="valor2" placeholder="So"  required="required"> + ( V .
