...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">S = So + (<strong> V </strong> . t )</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="MRUg3.php" id="formularioMRU">
						<label>S<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`MRUg3.php?valor1=${so}&valor2=${v}&valor3=${t}`);
		}
	</script>
</html>