...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>V = (S - So) / (t - ti)</h2>
			<form method="GET" action="MRUg3.php">
				<center>
				<h3><b>V = (<input type="number" name="valor1" placeholder="S"  required="required"> -
				...
				<input type="number" name="valor4" placeholder="ti"  required="required">)</b></h3>
