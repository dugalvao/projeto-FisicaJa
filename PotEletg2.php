...
<html lang="pt-br">
    <head>
        <title>Potencial Elétrico</title>
        <meta charset="utf-8">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			...
			<h3><?php echo "$valor1 = K . $valor2 / $valor3";?></h3><br/>
			<h3><?php echo "$valor1 . $valor3 = K . $valor2";?></h3><br/>
			<?php $util1 = $valor1 * $valor3 ;?>
			<h3><?php echo "$util1 = K . $valor2";?></h3><br/>
			<h3><?php echo "$util1 / $valor2 = K ";?></h3><br/>
			<?php $util2 = $util1 / $valor2 ;?>
			<h3><?php echo "K = $util2";?></h3><br/>
