...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "$valor1 = K . ( | $valor2 | . | $valor3 | ) / $valor4 ²";?></h3><br/>
			<?php $util1 = $valor4 * $valor4 ;
				  ...
				  ;?>
			<h3><?php echo "$valor1 = K . ( $valor2 . $valor3 ) / $util1";?></h3><br/>
			<?php $util2 = $valor2 * $valor3 ;?>
			<h3><?php echo "$valor1 = K . $util2 / $util1";?></h3><br/>
			<h3><?php echo "$valor1 / $util1 = ( K . $util2 )";?></h3><br/>
			<?php $util3 = $valor1 / $util1 ;?>
			<h3><?php echo "$util3 =  K . $util2 ";?></h3><br/>
			<h3><?php echo "$util3 /$util2 =  K ";?></h3><br/>
			<h3><?php echo "K = " . $util3 / $util2 . "";?></h3><br/>
