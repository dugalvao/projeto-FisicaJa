...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">c = <strong>Q </strong> /[m.(t-to)]</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="CalorEspg2.php" id="formularioMRU">
						<label id="aviso2">c<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`CalorEspg2.php?valor1=${c}&valor2=${m}&valor3=${t}&valor4=${to}`);
		}
	</script>
</html>