...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>c = <strong>Q</strong> / m . ( t - to )</h2>
			<form method="GET" action="CalorEspg2.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="c"  required="required"> = Q /
				<input type="number" name="valor2" placeholder="m"  required="required"> . (
				<input type="number" name="valor3" placeholder="t"  required="required"> -
				<input type="number" name="valor4" placeholder="to"  required="required"> )</b></h3>
