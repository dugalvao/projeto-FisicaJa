...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">c = Q /[ <strong>m</strong> .(t-to)]</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="CalorEspg3.php" id="formularioMRU">
						<label id="aviso2">c<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`CalorEspg3.php?valor1=${c}&valor2=${q}&valor3=${t}&valor4=${to}`);
		}
	</script>
</html>