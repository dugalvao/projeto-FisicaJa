...
<html lang="pt-br">
    ...
    <body>
  			...
  			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown" id="nomeusuario">
      				<a class="nav-link dropdown-toggle " href="#" id="navbardrop" data-toggle="dropdown" >
						...
						//esse codigo faz aparecer o nome do usuario que ta logado, legal
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10 p-3 mt-3">
		<h2 class="p-3">Carga elétrica</h2>
			<center>
			<h1 class="p-3">Q = n . e</h1>
			</center>
			<div class="container-fluid">
				<a href="#" class="btn btn-lg btn-block w-100 " style="text-decoration:none; color:black; background-color:#9bcd9b;">
					Ver mais
				</a>
			</div>
		</div><br/>
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10 p-3 mt-3">
		<h2 class="p-3">Força eletrostática (Lei de Coulomb)</h2>
			<center>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10 p-3 mt-3">
		<h2 class="p-3">Campo elétrico</h2>
			<center>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10 p-3 mt-3">
		<h2 class="p-3">Potencial elétrico</h2>
			<center>
