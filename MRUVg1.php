<?php
	...
	$valor3 = $_GET['valor3'];
	$valor4 = $_GET['valor4'];
	$resultado = (($valor1 + ($valor2 * $valor3)) + 1)/ (2 * ($valor4 * ($valor3 * $valor3)));
...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "S = ( $valor1 + $valor2 . $valor3 + 1 )/ ( 2 . $valor4 . $valor3 ² )";?></h3><br/>
			<h3><?php echo "S = ( $valor1 +". $valor2 * $valor3 ."+ 1 )/ ( 2 . $valor4 .". $valor3 * $valor3 .")";?></h3><br/>
			<?php $util1 = $valor1 + ($valor2 * $valor3);
				  $util2 = $valor4 * ($valor3*$valor3) ?>
			<h3><?php echo "S = ( $util1 + 1 )/ ( 2 . $util2)";?></h3><br/>
			<h3><?php echo "S =". ( $util1 + 1 )."/". ( 2 * $util2);?></h3><br/>
