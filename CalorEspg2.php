...
<html lang="pt-br">
    <head>
		<title>Calor Específico - Q</title>
        <meta charset="utf-8">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 = Q / $valor2 . ( $valor3 - $valor4 )";?></h3><br/>
			<?php $util1 = $valor3 - $valor4 ;?>
			<h3><?php echo "$valor1 = Q / $valor2 . $util1 "?></h3><br/>
			<?php $util2 = $valor2 * $util1 ;?>
			<h3><?php echo "$valor1 = Q / $util2 "?></h3><br/>
			<h3><?php echo "$valor1 . $util2 = Q "?></h3><br/>
			<?php $result =  $valor1 * $util2?>
			<?php $resultForm = number_format($result, 2,  ',', '')?>
			<h3> Q = <?php echo $resultForm?> cal</h3><br/>
		</div>
		<div class="row">
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar14.php",//pagina em php que ira fazer o insert dos dados
