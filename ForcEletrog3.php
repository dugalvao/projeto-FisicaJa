...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "$valor1 =  $valor2 . ( | Q1 | . | $valor3 | ) / $valor4 ²";?></h3><br/>
			<?php $util1 = $valor4 * $valor4 ;
				  if($valor3 < 0 ){
					  $valor3 = $valor3 * -1;
				  }
				  ;?>
			<h3><?php echo "$valor1 =  $valor2 . ( | Q1 | . $valor3 ) / $util1";?></h3><br/>
			<h3><?php echo "$valor1 . $util1 =  $valor2 . ( | Q1 | . $valor3 )";?></h3><br/>
			<?php $util2 = $valor1 * $util1 ;?>
			<h3><?php echo "$util2 = $valor2 . ( | Q1 | . $valor3 )";?></h3><br/>
			<h3><?php echo "$util2 / $valor2 =  | Q1 | . $valor3 ";?></h3><br/>
			<?php $util3 = $util2 / $valor2 ;?>
			<h3><?php echo "$util3 = | Q1 | . $valor3 ";?></h3><br/>
			<h3><?php echo "$util3 / $valor3 = | Q1 | ";?></h3><br/>
			<?php $util4 = $util3 / $valor3 ;?>
			<h3><?php echo "$util4 = | Q1 | ";?></h3><br/>
			<?php if($util4 < 0){
				$util4 = $util4 * -1 ;
			}
			;?>
			<h3><?php echo "Q1 = $util4";?></h3><br/>
