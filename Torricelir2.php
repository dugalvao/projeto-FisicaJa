...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">V² = <strong>Vo²</strong> + 2 . a . ( S - So )</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="Torricelig2.php" id="formularioMRU">
						<label>V<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`Torricelig2.php?valor1=${v}&valor2=${a}&valor3=${s}&valor4=${so}`);
		}
	</script>
</html>