...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 ² = Vo ² + 2 . $valor2 . ( $valor3 - $valor4 )";?></h3><br/>
			<?php $util1 = $valor1 * $valor1 ;
				  $util2 = $valor3 - $valor4 ;?>
			<h3><?php echo "$util1 = Vo ² +  2 .  ($valor2 .  $util2)";?></h3><br/>
			<?php $util3 = $util2 * $valor2 ;?>
			<h3><?php echo "$util1 = Vo ² + ( 2 . $util3 )";?></h3><br/>
			<h3><?php echo "$util1 = Vo ² + (" .  2 * $util3 .")";?></h3><br/>
			<h3><?php echo "$util1 - " . 2 * $util3." = Vo ² ";?></h3><br/>
			<?php $util4 = $util1 - ( 2 * $util3 ) ;?>
			<h3><?php echo "Vo ² = $util4";?></h3><br/>
			<h3><?php echo "Vo = √  $util4";?></h3><br/>
			<h3><?php $resposta = $util4;?></h3>
			<?php
				if($resposta < 0){
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar6.php",//pagina em php que ira fazer o insert dos dados
