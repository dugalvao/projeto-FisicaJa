...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 = $valor2 / $valor3 . ( $valor4 - to )";?></h3><br/>
			<h3><?php echo "$valor1 . $valor3 . ( $valor4 - to ) = $valor2 ";?></h3><br/>
			<?php $util1 = $valor1 * $valor3 ;?>
			<h3><?php echo "$util1 . ( $valor4 - to ) = $valor2 ";?></h3><br/>
			<h3><?php echo "$valor4 - to = $valor2 / $util1";?></h3><br/>
			<?php $util2 = $valor2 / $util1;
			$resultForm1 = number_format($util2, 2,  ',', '');?>
			<h3><?php echo "$valor4 - to = $resultForm1";?></h3><br/>
			<h3><?php echo "$valor4 = $resultForm1 + to";?></h3><br/>
			<h3><?php echo "$valor4 - $resultForm1 = to";?></h3><br/>
			<?php $util3 = $valor4 - $util2 ;?>
			<?php $resultForm2 = number_format($util3, 2,  ',', '');?>
			<h3><?php echo "to = $resultForm2 °C";?></h3><br/>
		</div>
		<div class="row">
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar17.php",//pagina em php que ira fazer o insert dos dados
