...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 ² = $valor2 ² +  2 . $valor3 . ( S - $valor4 ))";?></h3><br/>
			<?php $util1 = $valor1 * $valor1 ;
				  $util2 = $valor2 * $valor2 ;?>
			<h3><?php echo "$util1 = $util2 + ( 2 . ( $valor3 . ( S - $valor4 )))";?></h3><br/>
			<?php $util3 = $valor3 * $valor4 ;?>
			<h3><?php echo "$util1 = $util2 + ( 2 . (( $valor3 . S ) - $util3 ))";?></h3><br/>
			<?php $util4 = $util3 * 2 ;
				  $util5 = $valor3 * 2 ;?>
			<h3><?php echo "$util1 = $util2 + (( $util5 . S ) - $util4 )";?></h3><br/>
			<h3><?php echo "$util1 - $util2 = (( $util5 . S ) - $util4 )";?></h3><br/>
			<?php $util6 = $util1 - $util2 ;?>
			<h3><?php echo "$util6 = ( $util5 . S ) - $util4 ";?></h3><br/>
			<h3><?php echo "$util6 + $util4 = $util5 . S ";?></h3><br/>
			<?php $util7 = $util6 + $util4 ;?>
			<h3><?php echo "$util7 = $util5 . S ";?></h3><br/>
			<h3><?php echo "$util7 / $util5 = S ";?></h3><br/>
			<?php $resposta = $util7 / $util5;?>
			<?php $resultForm = number_format($resposta, 2,  ',', ''); ?>
			<h3><?php echo "S = " .$resultForm. " m";?></h3><br/>
		</div>
		<div class="row">
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar8.php",//pagina em php que ira fazer o insert dos dados
