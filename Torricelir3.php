...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">V² = Vo² + 2 .<strong> a </strong> . ( S - So )</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="Torricelig3.php" id="formularioMRU">
						<label>V<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`Torricelig3.php?valor1=${v}&valor2=${vo}&valor3=${s}&valor4=${so}`);
		}
	</script>
</html>