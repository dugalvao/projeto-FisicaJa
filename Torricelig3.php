<?php
	...
	$valor3 = $_GET['valor3'];
	$valor4 = $_GET['valor4'];
	$resultado =(($valor1 * $valor1) - ($valor2 * $valor2)) / 2 * ($valor3 - $valor4);
...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "a = $valor1 ² - $valor2 ² / 2 . ($valor3 - $valor4)";?></h3><br/>
			<h3><?php echo "a = " . $valor1 * $valor1 . " - " . $valor2 * $valor2 . " / 2 . " . ($valor3 - $valor4) ;?></h3><br/>
			<h3><?php echo "a = " . (($valor1 * $valor1) - ($valor2 * $valor2)) . " / " . 2 * ($valor3 - $valor4) ;?></h3><br/>
			<h3><?php echo "a = $resultado m/s²";?></h3><br/>
			<h3></h3><br/>
			<a href="">
