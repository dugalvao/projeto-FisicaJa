...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10" id="divs">
			<h3><?php echo "$valor1 = $valor2 . q / $valor3 ²";?></h3><br/>
			<?php $util1 = $valor3 * $valor3 ;?>
			<h3><?php echo "$valor1 = $valor2 . q / $util1";?></h3><br/>
			<h3><?php echo "$valor1 . $util1 = $valor2 . q";?></h3><br/>
			<?php $util2 = $valor1 * $util1 ;?>
			<h3><?php echo "$util2 = $valor2 . q";?></h3><br/>
			<h3><?php echo "$util2 / $valor2 = q ";?></h3><br/>
			<?php 
				$resp_campo_q = $util2/ $valor2;
	...
	<script>
			function salvar(){	
				...
				$.ajax({
					url: "salvar11.php",//pagina em php que ira fazer o insert dos dados
