...
<html lang="pt-br">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas"><strong>V²</strong> = Vo² + 2 . a . ( S - So )</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="Torricelig1.php" id="formularioMRU">
						<label>Vo<p>
							<input  id="valor1" name ="valor1"  type="number" placeholder="Vo"  onkeyup="pegarvalor();" maxlength="20">
						</label>
						<label>a<p>
							<input  id="valor2" name="valor2"  type="number" placeholder="a"   onkeyup="pegarvalor();" maxlength="20">
						</label><br/>
						<label>S<p>
							<input  id="valor3" name="valor3" type="number" placeholder="S"   onkeyup="pegarvalor();" maxlength="20">
						</label><br/>
						<label>So<p>
							<input  id="valor4" name="valor4"  type="number" placeholder="So"   onkeyup="pegarvalor();" maxlength="20">
						</label><br/>
						<div class="col-xs-12">
	...
	<script>
		function pegarvalor(){
			var vo = document.getElementById("valor1").value + "² +";
			//alert();
			var a = "2 . "+ document.getElementById("valor2").value + " . "
			var s = "( " + document.getElementById("valor3").value + " - "
			var so = document.getElementById("valor4").value + ")"

			var vox = document.getElementById("valor1").value;
			var ay = document.getElementById("valor2").value;
			var sz = document.getElementById("valor3").value;
			var sow = document.getElementById("valor4").value;
			...
			document.getElementById("r1").innerHTML = vo; //PEGA O VALOR DE so E SETA NO OBJETO "r1";
			...
			document.getElementById("r4").innerHTML = so;
		...
		function enviar(){
			...
			location.replace(`Torricelig1.php?valor1=${vo}&valor2=${a}&valor3=${s}&valor4=${so}`);
		}
	</script>
</html>