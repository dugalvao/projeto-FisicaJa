...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2><strong>V²</strong> = Vo² + 2. a . ( S - So )</h2>
			<form method="GET" action="Torricelig1.php">
				<center>
				<h3><b>V² = <input type="number" name="valor1" placeholder="Vo"  required="required">² + 2 .
				<input type="number" name="valor2" placeholder="a"  required="required"> . (
				<input type="number" name="valor3" placeholder="S"  required="required"> -
