...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "K - 273 / 5 = $valor1 / 5";?></h3><br/>
			<?php $util1 = $valor1 / 5 ;?>
			<h3><?php echo "K - 273 / 5 = $util1";?></h3><br/>
			<h3><?php echo "K - 273 = $util1 . 5";?></h3><br/>
			<?php $util2 = $util1 * 5 ;?>
			<h3><?php echo "K - 273 = $util2";?></h3><br/>
			<h3><?php echo "K = $util2 + 273";?></h3><br/>
			<?php $util3 = $util2 + 273 ;?>
			<h3><?php echo "K = $util3 K";?></h3><br/>
