...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10"> <!--arrumar daqui para baixo-->
			<h2>V = Vo + ( <strong>a</strong> . t )</h2>
			<form method="GET" action="EHVg3.php">
				<center>
				<h3><b><input type="number" name="valor1" placeholder="V"  required="required"> = 
				<input type="number" name="valor2" placeholder="Vo"  required="required"> + ( a .
