...
<html lang="pt-br">
    ...
    <body>
		...
		<div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h3><?php echo "$valor1 =  $valor2 . ( | $valor3 | . | $valor4 | ) / D²";?></h3><br/>
			<?php
				  if($valor3 < 0 ){
					  $valor3 = $valor3 * -1;
				  }
			...
			<h3><?php echo "$valor1 = $valor2 . $util1 / D²";?></h3><br/>
			<?php $util2 = $valor2 * $util1 ;?>
			<h3><?php echo "$valor1 = $util2 / D²";?></h3><br/>
			<h3><?php echo "$valor1 . $util2 = D²";?></h3><br/>
			<?php $util3 = $valor1 * $util2 ;?>
			<h3><?php echo "$util3 = D²";?></h3><br/>
			<h3><?php echo "D = √  $util3";?></h3><br/>
			<h3><?php echo "D = " . sqrt($util3) . "";?></h3><br/>
