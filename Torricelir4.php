...
<html lang="pt-br">
	...
	<div class="container-fluid col-10 col-sm-10 col-md-10 col-xl-10 p-3 mt-3">
		...
		<!-- <div class="container col-12 col-sm-12 col-md-10 col-xl-10">
			<h2>V² = Vo² + 2. a . ( <strong>S</strong> - So )</h2>
			<form method="GET" action="Torricelig4.php">
				<center>
				...
				<input type="number" name="valor3" placeholder="a"  required="required"> . ( S - 
				<input type="number" name="valor4" placeholder="So"  required="required"> )</b></h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<h2 class="p-3 mt-3" id="h2formulas">V² = Vo² + 2 . a . (<strong>S</strong> - So )</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<form action="GET" action="Torricelig4.php" id="formularioMRU">
						<label>V<p>
	...
	<script>
		...
		function enviar(){
			...
			location.replace(`Torricelig4.php?valor1=${v}&valor2=${vo}&valor3=${a}&valor4=${so}`);
		}
	</script>
</html>